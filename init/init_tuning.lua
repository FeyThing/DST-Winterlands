...
--	Worldgen
	...
	TUNING.POLAR_ICICLE_GROWTIME = total_day_time * 0.5
	TUNING.POLAR_ICICLE_GROWTIME_VARIANCE = seg_time
	TUNING.POLAR_ICICLE_SPAWNTIME = seg_time * 4
