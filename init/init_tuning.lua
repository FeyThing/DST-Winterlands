...
--	Mobs
	...
	TUNING.POLAR_MOOSE_KNOCK_COOLDOWN = 2
	TUNING.POLAR_MOOSE_KNOCK_COOLDOWN_MISS = 1
	...
	TUNING.POLARFLEA_HOST_RANGE = 15
	...
	TUNING.POLARFLEA_STORM_REGEN_RATE = 2
	TUNING.POLARFLEA_WORLD_MAXFLEAS = 100
	
	TUNING.THRONE_KRAMPUS_RANGE_MULT = 1.5
	TUNING.THRONE_KRAMPUS_STAY_TIME_MIN = 35
	TUNING.THRONE_KRAMPUS_STAY_TIME_MAX = 50
...
--	Buildings
	...
	TUNING.POLAR_THRONE_GIFTRING_DIST = 10
...
--	Misc
	...
	TUNING.HUNT_ALTERNATE_POLAR_CHANCE_MIN = TUNING.HUNT_ALTERNATE_BEAST_CHANCE_MAX / 2
	TUNING.HUNT_ALTERNATE_POLAR_CHANCE_MAX = TUNING.HUNT_ALTERNATE_BEAST_CHANCE_MAX * 2
