...
--  Bosses
	...
	TUNING.EMPEROR_PENGUIN_ATTACK_PERIOD = 3
	TUNING.EMPEROR_PENGUIN_ATTACK_DIST = 3
	TUNING.EMPEROR_PENGUIN_SPIN_COOLDOWN = 10
	TUNING.EMPEROR_PENGUIN_SPIN_DURATION = 5
	TUNING.EMPEROR_PENGUIN_SPIN_SPEEDMULT = {1.25, 1.5}
	TUNING.EMPEROR_PENGUIN_SUMMONS_HEALTH_PERCENT = {1, 0.85, 0.65, 0.5, 0.35}
	TUNING.EMPEROR_PENGUIN_SUMMONS_KILL_PERCENT = 0.75
	TUNING.EMPEROR_PENGUIN_SUMMONS_NUM = {3, 5, 7, 10, 14}
