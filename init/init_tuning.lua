...
--	Configs
	...
	TUNING.POLAR_ICEGEN_CONFIG = 0 -- GetModConfigData("polar_icegen") or 0 (Those are now world-settings)
	TUNING.POLAR_BLIZZARDS_CONFIG = 0 -- GetModConfigData("polar_blizzards") or 0
	TUNING.POLAR_WAVES_ENABLED = true -- GetModConfigData("polar_snow") ~= false
...
--	Worldgen
	...
	TUNING.POLAR_ICEGEN_DEFAULT_BLOCKED_TIME = day_time -- Time before ice / ocean tiles blocked by entities start updating again
	TUNING.POLAR_ICEGEN_DEFAULT_HOLE_TIME = total_day_time -- Time before ice can return after being destroyed
	
	TUNING.POLAR_ICEGEN_BLOCKER_DIST = 8 -- Dist from stuff that prevents ice growth (like boat)
	TUNING.POLAR_ICEGEN_DESTROY_BLOCKER_DIST = 5 -- Dist from stuff that prevents ice breaking (like pillars)
	...
	TUNING.ICELETTUCE_COOLING = -5 -- Eaten (smoll)
	TUNING.ICELETTUCE_FREEZABLE_COLDNESS = 2
	TUNING.ICELETTUCE_KILLJOY_TOLERANCE = 0
	TUNING.ICELETTUCE_REGROWTH_CHANCE = 0.75
	TUNING.ICELETTUCE_REGROWTH_RANGE_SQ = 140
...
--	Players
	...
	TUNING.WX78_NAUGHTY_CHIPBOOSTS = {1, 2, 2.5, 3, 3.5, 4, 5} -- Added naughtiness mult
	TUNING.WX78_NAUGHTY_CHIPSANITY = 0.25 -- Sanity gained x naughtiness x circuits installed
...
--	Mobs
	...
	TUNING.SPECTER_MOOSE_HEALTH = 1500
	
	-- Pengulls
	TUNING.PENGUIN_GUARD_DAMAGE = 66
	TUNING.PENGUIN_GUARD_DAMAGE_PLAYER_PERCENT = 0.5
	...
	TUNING.POLARBEAR_DAMAGE_BITE_MULT = 1.5
	...
	TUNING.POLARBEAR_LOYALTYBOOST_DURATION = total_day_time * 10
	TUNING.POLARBEAR_LOYALTYBOOST_MULT = 2
	TUNING.POLARBEAR_WORKEFFECTIVENESS_MODIFIER = 3
	TUNING.POLARBEAR_WORKEFFECTIVENESS_RAGE_MODIFIER = 6
	...
	TUNING.POLARBEAR_TREASURES_DATA = {
		houndstooth = {amt = 1}, -- All trades give +1 with Ursa Major 1st trial buff, unless cantboost = true
		walrus_tusk = {amt = 3},
		gnarwail_horn = {amt = 3},
		polarwargstooth = {amt = 5},
		lavae_tooth = {amt = 6},
	}
	...
	TUNING.TRIALS_INGREDIANT_ACCESS_RADIUS = 30 -- TODO: We should reduce this later (~20) but we need a free method to wrangle far away bears (horn call or idk)
	TUNING.TRIALS_WIN_MAX_HEALING = TUNING.MAX_HEALING_NORMAL
	TUNING.TRIALS_START_TIME = 3.5
	
	-- Frost Tails
	TUNING.POLARFOX_HEALTH = 200
	TUNING.POLARFOX_DAMAGE = 30 -- Unused
	...
	TUNING.POLARFOX_FURSWAP_TEMP = {min = -5, max = 5}
	TUNING.POLARFOX_FURSWAP_TIME = {min = total_day_time, max = total_day_time * 2}
	...
	TUNING.POLARFLEA_INV_INSULATION = 30
	...
	TUNING.POLARFLEA_BABY_SCALE = 0.75
	
	TUNING.POLARFLEA_MOTHER_HEALTH = 2500
	TUNING.POLARFLEA_MOTHER_DAMAGE = 30
	TUNING.POLARFLEA_MOTHER_TONGUE_DAMAGE = 17
	TUNING.POLARFLEA_MOTHER_ATTACK_RANGE = 3
	TUNING.POLARFLEA_MOTHER_ATTACK_PERIOD = 4
	TUNING.POLARFLEA_MOTHER_CHARGE_SPEED = 9.5
	TUNING.POLARFLEA_MOTHER_RUN_SPEED = 4
	TUNING.POLARFLEA_MOTHER_WALK_SPEED = 1
	TUNING.POLARFLEA_MOTHER_FLEAS_SPAWN_COOLDOWN = 10
	TUNING.POLARFLEA_MOTHER_FLEAS_SPAWN_DIST = 16
...
--  Bosses
	...
	-- Emperor Pengull
	TUNING.EMPEROR_PENGUIN_HEALTH = 4000
	TUNING.EMPEROR_PENGUIN_HEALTH_CUTDAMAGE = TUNING.EMPEROR_PENGUIN_HEALTH / 4
	TUNING.EMPEROR_PENGUIN_DAMAGE = 80
	TUNING.EMPEROR_PENGUIN_DAMAGE_SPINMOD = 0.5
	TUNING.EMPEROR_PENGUIN_DAMAGE_PLAYER_PERCENT = 0.5
	...
	TUNING.EMPEROR_PENGUIN_SUMMONS_NUM = {3, 4, 5, 6, 7}
	TUNING.EMPEROR_PENGUIN_WALK_SPEED = 1
	TUNING.EMPEROR_PENGUIN_RUN_SPEED = 8
	TUNING.EMPEROR_PENGUIN_SNOWBALL_SPAWNPERIOD = 0.5
	TUNING.EMPEROR_PENGUIN_SNOWBALL_TYPE_THROWS = {1, 1, 2, 1, 1, 2, 1, 2, 1, 2, 3}
	...
	TUNING.EMPEROR_PENGUIN_CASTLE_DEFEATED_DESPAWN_TIME = total_day_time
	TUNING.EMPEROR_PENGUIN_CASTLE_RANGE = 20 -- Includes outdoor activity range
	TUNING.EMPEROR_PENGUIN_CASTLE_REVEAL_MAP_IN_RANGE = 3500
	TUNING.SPAWN_EMPEROR_PENGUIN = true
	TUNING.SPAWN_EMPEROR_PENGUIN_MOD = 1
	
	-- Frosty the SoonTMman
	TUNING.FROSTY = {
		SIMPLE = {
			TARGETING_DIST = 10,
...
--	Items
	...
	TUNING.WINTERS_FISTS_DAMAGE_FROZEN_MULT = 2
	TUNING.WINTERS_FISTS_DAMAGE_SMALLBALL = TUNING.WINTERS_FISTS_DAMAGE * 0.5
	TUNING.WINTERS_FISTS_DAMAGE_MEDBALL = TUNING.WINTERS_FISTS_DAMAGE
	TUNING.WINTERS_FISTS_DAMAGE_SNOWBALL = TUNING.WINTERS_FISTS_DAMAGE * 4
	TUNING.WINTERS_FISTS_SLOW = 0.9
	TUNING.WINTERS_FISTS_POUND_COLDNESS = 1
	TUNING.WINTERS_FISTS_SPELL_TYPES = 3
	TUNING.WINTERS_FISTS_SNOWBALL_COLDNESS = 0.5
	TUNING.WINTERS_FISTS_SNOWBALL_GIANT_COLDNESSPERCENT = 0.9
	TUNING.WINTERS_FISTS_SNOWBALL_COOLDOWN = 2
	TUNING.WINTERS_FISTS_SNOWBALL_GIANT_GROGGINESS = 1
	TUNING.WINTERS_FISTS_SNOWBALL_GIANT_MAXTIME = 3
	...
	TUNING.DESICCANT_POLARSNOW_DELTA = 1
	TUNING.DESICCANT_POLARSNOW_RATE = 0.65
	TUNING.DESICCANTBOOSTED_POLARSNOW_DELTA = 0.5
	TUNING.DESICCANTBOOSTED_POLARSNOW_RATE = 0.65
	...
	TUNING.POLARFLEAEGGSACK_NUM_FLEAS = 8
	...
	--TUNING.WINTERS_FEAST_TREE_DECOR_LOOT.FROSTY = {basic = 2, special = "winter_ornament_boss_frosty"}
...
--	Buffs
	...
	TUNING.URSAMAJOR_BUFF_DURATION = total_day_time * 6
	
	TUNING.POCKETWATCH_BUFF_DURATION = total_day_time
	TUNING.POCKETWATCH_BUFF_TICK = 0.06
	TUNING.POCKETWATCH_BUFF_TRAIL_PUPPETS = 12
...
--	Buildings
	...
	TUNING.MOBHEADS_COMBAT_BUFF_RANGE = 24
	TUNING.MOBHEADS_COMBAT_BUFF_STACKING = 4
	TUNING.MOBHEADS_COMBAT_ARMOR_MULT = -0.125
	TUNING.MOBHEADS_COMBAT_DAMAGE_MULT = 0.125
	
	TUNING.POLARAMULET_STATION_SPEAKTIME = 2
	
	TUNING.POLARBEAR_RUG_INSULATION = TUNING.INSULATION_MED
	TUNING.POLARBEAR_RUG_MULT_CANADIAN = 1.5
	TUNING.POLARBEAR_RUG_RADIUS = 3.5
	...
	TUNING.POLARICE_PLOW_PONDDIST = 2.2
	TUNING.POLARICE_PLOW_TEMPORARY_TILE_MIN_DURATION = 10 -- Cannot plow ice on a short-lived ice tile
	
	TUNING.POLARWALL_HEALTH = 600
	TUNING.POLARWALL_FREEZE_INSULATION_MIN = 120
	...
	TUNING.VASE_FLOWER_MAP.petals_polar = {141, 142, 143} -- Unique IDs (added on 1.4 update...)
	TUNING.VASE_FLOWER_SWAPS[141] = {lightsource = false, sanityboost = 5}
	TUNING.VASE_FLOWER_SWAPS[142] = {lightsource = false, sanityboost = 5}
	TUNING.VASE_FLOWER_SWAPS[143] = {lightsource = false, sanityboost = 5}
...
--	Misc
	...
	TUNING.SNOWWAVER_UPDATE_RATE = 1
	...
	-- Hunting
	TUNING.HUNT_ALTERNATE_POLAR_CHANCE_MIN = 0 -- AKA: 100% chances for Moose in Summer (if not Koalefant...)
	...
	TUNING.HUNT_KOALEFANT_POLAR_CHANCE = 0.5 -- NEW: Winter Koalefant tries to spawn before ANYTHING else above ^
	...
	TUNING.POLAR_STORM_RAMP_TIME = seg_time * 2
	...
	-- Breaking frozen ponds
	TUNING.FROZENPOND_BREAK_ICE_TIME = total_day_time * 2 -- Ice Demoleisher
	TUNING.FROZENPOND_BREAK_ICE_TIME_LESS = total_day_time * 0.5 -- Others (explosives, groundpound...)
	TUNING.FROZENPOND_WORK_SLIPPERY_DELTA = {min = 8, max = 16}
	TUNING.FROZENPOND_WORK = 7
	...
	-- Shade / FX
	TUNING.POLAR_MIST_LIFETIME = 15
	
	TUNING.SHADE_POLAR_RANGE = 24
