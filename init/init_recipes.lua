...
PolarRecipe("polarcrownhat", 		{Ingredient("ice", 200), Ingredient("bluegem_shards", 6)}, 													TECH.LOST, 					{no_deconstruction = true, nounlock = true, sg_state = "give"}, 	{"CRAFTING_STATION"})--{"ARMOUR", "MAGIC"}, {"dreadstonehat", "dreadstonehat"})
