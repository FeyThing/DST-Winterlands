...
--	Announcements
	...
	--	Actions
	ANNOUNCE.BATTLECRY.POLARBEAR = "你能让我留下一道好看的伤疤吗？"
	...
	ANNOUNCE.ANNOUNCE_DETACH_BUFF_POLARWETNESS = "愿洛基将我从这个湿答答的噩梦中晒干！"
...
--	Worldgen
	...
	DESCRIBE.ANTLER_TREE = {
		BURNING = "树啊，我会想念你的树枝。",
		BURNT = "可惜，它已被赫尔的火焰吞噬。",
		CHOPPED = "它在一场光荣的战斗中倒下了。",
		GENERIC = "你的树枝可以成为一件很好的武器。",
	}
	DESCRIBE.ICELETTUCE_SEEDS = "这是一颗种子，不是肉。"
	
	--	Rocks and stones
	DESCRIBE.POLAR_ICICLE = "来自上天的死亡！"
	DESCRIBE.POLAR_ICICLE_ROCK = "哈哈！洛基的诡计对我无效！"
	DESCRIBE.ROCK_POLAR = "冰从地下提供了物品。"
	
	--	Misc
	ANNOUNCE.DESCRIBE_IN_POLARSNOW = "朋友，还是冰友？"
	DESCRIBE.TUMBLEWEED_POLAR = "带着冬季力量的旋转先驱。"
	
--	Mobs
	
	DESCRIBE.MOOSE_POLAR = {
		ANTLER_LOST = "哈！你自己解除武装了！",
		GENERIC = "芙蕾雅的恩典触及了这片冰封之地。",
	}
	DESCRIBE.MOOSE_SPECTER = "隐藏在斯卡迪面纱中的生物。"
	DESCRIBE.OCEANFISH_MEDIUM_POLAR1 = "它的光泽预示着一顿美餐。"
	DESCRIBE.POLARBEAR = {
		DEAD = "愿你的灵魂回归瓦尔哈拉。",
		ENRAGED = "用你所有的力量来战斗！",
		FOLLOWER = "来自冰雪之地的伙伴。",
		GENERIC = "强壮的北欧战士，所有鱼类王国都惧怕他们。",
	}
	DESCRIBE.POLARFLEA = {
		GENERIC = "哦，天哪！",
		HELD_INV = "可以移除，但要付出我的皮肤作为代价。",
...
--	Items
	...
	DESCRIBE.BLUEGEM_SHARDS = "宝石被击败。"
	DESCRIBE.MOOSE_POLAR_ANTLER = "祝你好运……"
	DESCRIBE.POLAR_DRYICE = "来自冰霜巨人的碎片！"
	DESCRIBE.POLARBEARFUR = "只有最凶猛的战士才能获得的毛皮。"
	DESCRIBE.POLARWARGSTOOTH = "拥有它就能驯服寒冷。"
	...
	DESCRIBE.TRAP_POLARTEETH = "危险潜伏在雪下。"
