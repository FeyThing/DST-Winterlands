...
--	Worldgen
	...
	--	Plants
	NAMES.ANTLER_TREE = "Pokoroże"
	NAMES.FARM_PLANT_ICELETTUCE = "Sałata Lodowa"
	NAMES.GRASS_POLAR = "Trawa Tundrowa"
	NAMES.ICELETTUCE_SEEDS = "Zmrożone Nasionko"
	NAMES.KNOWN_ICELETTUCE_SEEDS = "Nasionko Sałaty Lodowej"
	
	--	Rocks and stones
	NAMES.POLAR_ICICLE = "Sopel"
	NAMES.POLAR_ICICLE_ROCK = "Sopel"
	NAMES.POLAR_ICICLE_STAFF = "Sopel"
...
--	Mobs
	...
	NAMES.OCEANFISH_MEDIUM_POLAR1_INV = "Okoń Północny"
	NAMES.POLAR_PENGUIN = "Pingwin"
	NAMES.POLARBEAR = "Niedźwiedź Polarny"
	NAMES.POLARFLEA = "Śnieżna Pchła"
	NAMES.POLARFOX = "Mroźnogon"
	NAMES.POLARWARG = "Lodowy Varg"
	NAMES.SHADOW_ICICLER = "Cienisty Grzbiet"
...
--	Buildings
	...
	NAMES.POLAR_THRONE_GIFTS = "Góra Prezentów"
	NAMES.POLARAMULET_STATION = "\"Wymieniacz Polarny\""
	NAMES.POLARBEARHOUSE = "Niedźwiedzia Chata"
	NAMES.POLARICE_PLOW = "Pług Lodowy"
	NAMES.POLARICE_PLOW_ITEM = "Pług Lodowy"
...
--	Items
	...
	NAMES.WINTERCOOKING_POLARCRABLEGS = "Królewskie Nóżki Krabowe"
	...
	NAMES.POLARWARGSTOOTH = "Lodowy Kieł"
	...
	NAMES.POLARAMULET = "Naszyjnik z Zębów"
	NAMES.POLARAMULET_BUILDER = "Naszyjnik z Zębów"
	NAMES.POLARBEARHAT = "Niedźwiedzia Głowa"
	NAMES.POLARCROWNHAT = "Lodowa Korona"
	...
	NAMES.DUG_GRASS_POLAR = "Tundrowa Kępka"
	NAMES.POLARGLOBE = "Dziwna Kula Śnieżna"
	NAMES.OCEANFISH_IN_ICE = "Śmierdzący Rybą Lód"
	...
	NAMES.WALL_POLAR = "Ściana z Suchego Lodu"
	NAMES.WALL_POLAR_ITEM = "Ściana z Suchego Lodu"
	NAMES.WINTER_ORNAMENTPOLAR = "Mroźna Ozdoba"
	NAMES.WX78MODULE_NAUGHTY = "Obwód Dla Niegrzecznych"
...
--	Speech, etc
	...
	STRINGS.POLARBEAR_LOOKATWILSON = {"DOBRY DZIEŃ NA RYBY", "SNIFF", "BRR...", "NA PRZEŁAMANIE LODU, DOBREGO DNIA", "... EH?", "HO HO! MAŁY JAK PINGWIN!", "TY NIE MORS?", "PATRZ NA ŚNIEG", "ZIMNO JEST NA ZEWNĄTRZ", "WEWNĄTRZ TEŻ ZIMNO JEST", "KTO TAM?", "NA POLOWANIE WKRÓTCE?"}
	STRINGS.POLARBEAR_LOOKATBEARSON = {"HMM...", "WSZYSTKO W PORZĄDKU, BRACIE?", "PACHNIESZ... DZIWNIE", "NIC DZISIAJ NIE ŁAPIĄ", "CO DO..."}
	STRINGS.POLARBEAR_FOLLOWWILSON = {"CHODŹMY NA RYBY", "GDZIE IDZIEMY?", "SNIFF SNIFFFF", "TY MAŁY ALE MIŁY", "OH HO HO!", "TUŻ ZA TOBĄ", "TOBIE NIE ZIMNO?", "EH? BIEGNE!"}
	STRINGS.POLARBEAR_ATTEMPT_TRADE = {"SNIFF SNIFF!", "HO HO A CO TO?", "TEN ZAPACH..."}
	STRINGS.POLARBEAR_FUELBRAZIER = {"KAWAŁKIEM FUTRA SIĘ PODZIELE", "BRRRR!", "TROCHĘ SIE OGRZAĆ", "JAK ZIMNO!"}
	STRINGS.POLARBEAR_PLOWSNOW = {"PA PA ŚNIEG", "TYLE ŚNIEGU...", "HUFF", "BRR...", "CIĄGLE WIĘCEJ ŚNIEGU...", "WIECEJ ŚNIEGU NIŻ WCZORAJ..."}
	STRINGS.POLARBEAR_FIGHT = {"RAAAAAAAAWRR", "RAAAWRRRRRRRR!", "GRRRRAAAWWW", "BIJ, PŁOTKO", "ROZERWE CIĘ", "ZAŁATWIE CIĘ!", "WRACAJ TUTAJ", "WALCZ! WALCZ!", "TY WRACAJ"}
	STRINGS.POLARBEAR_FISHFIGHT = {"DUŻA SOCZYSTA RYBA", "JEŚLI ŚMIERDZI...", "RYBA! RYBA!", "JUŻ GŁODNIAŁEM", "OHO, CHODŹ TU", "SARDYNKA W POBLIŻU", "CHODŹ TU RYBKO", "MNIAM!"}
	STRINGS.POLARBEAR_FOOLFIGHT = {"GŁUPEK!", "NADCHODZĘ", "OH HO HO", "OH HO, ZNALAZŁEM GŁUPKA", "TY GŁUPKU", "GONISZ", "CO ZA GŁUPEK"}
	STRINGS.POLARBEAR_FIND_FOOD = {"MMM... PAPU", "HO HO!", "ALE ŁADNY ZAPACH!", "TO DOBRE", "MNIAM... PAPU", "OH HO HO TAK!"}
	STRINGS.POLARBEAR_FIND_TOOTH = {"TO JEST WARTE!", "NADA SIĘ", "TAKI ŁADNY ZĄB!", "MÓJ, MÓJ!"}
	STRINGS.POLARBEAR_REFUSE_FOOD = {"NIE E", "BLE!", "TO LEDWO ZAKĄZKA"}
	STRINGS.POLARBEAR_GOHOME = {"ZIEEEEW!", "ZMĘCZONY...", "NIE PODOBA SIĘ CIEMNOŚĆ!", "CZAS NA DRZEMKE", "PÓŹNO JUŻ...", "NOC TAKA ZIMNA..."}
	STRINGS.POLARBEAR_BLIZZARDSOON = {"MA ŁOPATE GOTOWĄ?", "ZBLIŻA SIĘ", "WIATR SIĘ WZNOŚI...", "ŚNIEG DZIŚ INACZEJ PACHNIE", "JUTRO ZŁA PORA NA WĘDKOWANIE", "TY LEPIEJ IDŹ DO DOMU", "ŚNIEGU CORAZ WIĘCEJ"}
	STRINGS.POLARBEAR_BLIZZARD = {"BBBRRRRR", "BRR... ZA ZIMNO!", "ZNOWU!", "NADCHODZIII!", "TEGO NIE ODŚNIEŻYSZ", "NIE MA WĘDKOWANIA DZISIAJ"}
	STRINGS.POLARBEAR_PANICHAUNT = {"AJ!", "II!", "STRASZNY ŚNIEG!", "OHO OOOOO"}
	STRINGS.POLARBEAR_PANICFIRE = {"OGIEEEŃ!", "NIE ZIMNY! NIE ZIMNY!", "TOPNIEJE!", "AAAAAA!", "OHO NIEEEE!"}
	STRINGS.POLARBEAR_PANICHOUSEFIRE = {"OH NIE NIE NIE!", "KTOŚ RYBE SMAŻY?", "DOM TOPNIEJE!", "DOM ZA CIEPŁY!"}
	STRINGS.POLARBEAR_PROTECTSTUFF = {"NIE BEZ WALKI", "STÓJ!", "EH? NIE DOTYKAĆ", "SPADAJ, ZŁODZIEJU", "OH HO HO, TY!"}
	STRINGS.POLARBEAR_RESCUE = {"POTRZEBA ŁAPY?", "BIEGNIE, BIEGNIE!", "HO HO!"}
	STRINGS.POLARBEAR_STICKARCTICFISH = {"...", "SKUSISZ SIĘ NA RYBE?", "EH HEH...", "MASZ COŚ NA SOBIE", "OH HO...", "CHCESZ DARMOWEJ RYBY?", "NO WITAM"}
	STRINGS.POLARBEAR_TOOTHTRADE_PRE = {"HMM... OH HO!", "WYGLĄDA NA OSTRY!", "Z NIEGO WYJDZIE ŁADNY", "NIE ZŁY, NIE ZŁY", "TAK..."}
	STRINGS.POLARBEAR_TOOTHTRADE_PST = {"ZASŁUŻYŁEŚ", "PROSZĘ, JESZCZE ŚWIEŻE", "OTO MOJA OFERTA", "MOŻESZ TO WZIĄĆ", "BIERZ TO", "BIERZ, BIERZ!", "ŚWIETNY HANDEL"}
	STRINGS.POLARBEAR_TOOTHTRADE_EMPTY = {"PUSTY MAGAZYN", "NIC DO HANDLU NIE MAM", "BIERZESZ ŚNIEŻNE PCHŁY?", "PUSTO"} -- Unused (for now?)
	...
	STRINGS.POLARAMULET_STATION_WAITING = {
		...
		{"...jak masz line...", "...i... śśśliczne kły...", "...możemy ubić targu."},
		{"...nie, nie kupie ryby...", "...wybacz."},
	}
	STRINGS.POLARAMULET_STATION_PENDING = {
		"...nadal mam twoje liny.",
		{"...nareszcie mam te...", "...hmm, śśśliczne kły?"},
		{"...gotowy dobić...", "...hmm... targu?"},
	}
	STRINGS.POLARAMULET_STATION_BUILDER_PRE = {
		"...ahh... perrrfekcyjnie.",
		"...ho ho!",
		"...teraz... jeśli masz kły.",
		"...perrrfekcyjnie!",
		"...ta lina... jest perrrfekcyjna.",
		"...to są dobre liny.",
		{"...a teraz...", "...najlepsza część."},
	}
	STRINGS.POLARAMULET_STATION_BUILDER_LOOP = {
		"...",
		"...zostałeś... teraz zainspirowany?",
		"...możesz... połowić, póżniej.",
		{"...to może... zaczekać...", "...jeśli potrzebujesz."},
	}
	STRINGS.POLARAMULET_STATION_BUILDER_PST = {
		"...jest... piękne!",
		"...moje podziękowania.",
		"...tak... tak!", 
		"...możesz być... duuumny z tego jednego.",
		{"...", "...wrócisz wkrótce?"},
		{"...będzie wyglądało ładnie...", "...na twojej pięknej szyi."},
	}
	STRINGS.POLARAMULET_STATION_TOOTH_TIPS = {
		{"...róg nawrrrala...", "...pomoże ci na wodzie...", "...to też kły, wiesz?"},
		{"...psie kły...", "...dają... siłe, mhm."},
		{"...lodowe kły będą...", "...cię chronić... przez mrozem."},
		{"...zęby lawowca mogą...", "...ochronić cię... przed zimnem."},
		{"...kieł morsa...", "...wysoce... hmm, ceniooony tutaj."},
	}
	
	STRINGS.LUCY.container_has_fleas = {
		"Ack! Dotkneło mnie!",
		"Ochhhhydne stworzenie!",
		"NIGDY więcej mnie tam nie chowaj!",
		"Iiii!",
		"Złazić ze mnie, głupie robaki!",
		"Tylko nie pchły!",
		"Co to był-- AAAA!",
		"Ochyda! Ja się zwijam.",
	}
...
--	UI
	...
	STRINGS.ACTIONS.STICK_ARCTIC_FISH = {
		...
		VAR6 = "Naprawdę?",
		VAR7 = "Tak! Tak!",
		VAR8 = "No dawaj. Zrób to.",
		VAR9 = "Zrób my psikusa!",
		VAR10 = "Biedulinka.",
		VAR11 = "Nie odpuszczaj.",
		VAR12 = "Jesteś pewien?",
		VAR13 = "Oooo tak!",
		VAR14 = "Plecy! Na plecy!",
		VAR15 = "Głupek...",
	}
	
	--	Scrapbook, Cookbook
	STRINGS.UI.COOKBOOK.FOOD_EFFECTS_ICELETTUCE = "Przyzwyczaja ciało do śniegu"
	...
	STRINGS.SCRAPBOOK.SPECIALINFO.POLAR_BRAZIER = "Emituje światło i ciepło póki ma opał oraz pozwala na przygotowywanie jedzenia.\n\nMoże być ponownie używane a nawet zkładane żeby móc je podnieść."
	STRINGS.SCRAPBOOK.SPECIALINFO.POLAR_THRONE = "Ktoś lub coś często zostawia tu prezenty, chociaż czasami są przenoszone gdzie indziej."
	STRINGS.SCRAPBOOK.SPECIALINFO.POLAR_THRONE_GIFTS = "Darmowe prezenty!"
	STRINGS.SCRAPBOOK.SPECIALINFO.POLARAMULET = "Może utrzymać 3 kły, które ponoć noszą ze sobą moce.\n\nJakie moce? Kto wie.\nMoże ta... istota(?) w tej chałupie."
	...
	STRINGS.SCRAPBOOK.SPECIALINFO.POLARICEPLOW = "Wykopuje dużą dziurę w lodzie w kształcie świetnego łowiska!"
	...
	RECIPE_DESC.POLARCROWNHAT = "Panuj nad zamiecią!"
	RECIPE_DESC.POLARFLEA_SACK = "Noś przy sobie masę pełzających przyjaciół!"
	RECIPE_DESC.POLARICE_PLOW_ITEM = "Wykop dziurę i zobacz co się kryję pod lodem."
	...
	STRINGS.UI.CRAFTING.NEEDSARCTIC_FOOL = "Dostępny podczas Prima Arktilis!"
	STRINGS.UI.CRAFTING.NEEDSPOLARAMULET_STATION = "Odblokuj poprzez handel z pewnym podejrzanym osobnikiem..."
	STRINGS.UI.CRAFTING.NEEDSTECH.POLARSNOW = "Za mało śniegu!"
	STRINGS.UI.CRAFTING_STATION_FILTERS.POLARAMULET_STATION = "\"Wymieniacz Polarny\""
	
	--	Misc
	STRINGS.UI.SANDBOXMENU.POLARSTART = "Kraina Lodu"
	STRINGS.UI.CUSTOMIZATIONSCREEN.TASKSETNAMES.POLAR = "Kraina Lodu"
	STRINGS.UI.CUSTOMIZATIONSCREEN.PRESETLEVELS.SURVIVAL_POLAR = "Kraina Lodu"
	STRINGS.UI.CUSTOMIZATIONSCREEN.PRESETLEVELDESC.SURVIVAL_POLAR = "Chłodne przyjęcie od samego początku, z dala od krzykliwego wejścia od zaplecza."
	STRINGS.UI.CUSTOMIZATIONSCREEN.ARCTIC_FOOLS = "Prima Arktilis"

	STRINGS.UI.SANDBOXMENU.WORLDSETTINGS_POLAR = "Kraina Lodu"
	STRINGS.UI.SANDBOXMENU.WORLDGENERATION_POLAR = "Kraina Lodu"
	STRINGS.UI.SANDBOXMENU.SPECIAL_EVENTS.ARCTIC_FOOLS = "Prima Arktilis"
	
	STRINGS.UI.CUSTOMIZATIONSCREEN.EMPEROR_PENGUIN = "Cesarz Pingwin"
	STRINGS.UI.CUSTOMIZATIONSCREEN.ICELETTUCE_REGROWTH = "Dzikie sałaty lodowe"
	STRINGS.UI.CUSTOMIZATIONSCREEN.MOOSE_POLAR = "Łosie"
	STRINGS.UI.CUSTOMIZATIONSCREEN.POLAR_ICICLES = "Sople"
	STRINGS.UI.CUSTOMIZATIONSCREEN.POLAR_THRONE = "Niegrzeczny Tron"
	STRINGS.UI.CUSTOMIZATIONSCREEN.POLARBEARS = "Niedźwiedzie Polarne"
	STRINGS.UI.CUSTOMIZATIONSCREEN.POLARFLEAS = "Śnieżne Pchły"
	STRINGS.UI.CUSTOMIZATIONSCREEN.POLARFOXES = "Mroźnogony"
	STRINGS.UI.CUSTOMIZATIONSCREEN.TUMBLEWEED_POLAR = "Biegusy Tundrowe"
	
	STRINGS.UI.CUSTOMIZATIONSCREEN.ANTLER_TREES = "Pokoroże"
	STRINGS.UI.CUSTOMIZATIONSCREEN.GRASS_POLAR = "Trawa Tundrowa"
	STRINGS.UI.CUSTOMIZATIONSCREEN.POLARBEARHOUSES = "Niedźwiedzie Chaty"
	STRINGS.UI.CUSTOMIZATIONSCREEN.ROCKS_POLAR = "Lodowe Wzgórki"
	
	STRINGS.UI.SPECIAL_EVENT_NAMES.ARCTIC_FOOLS = "Prima Arktilis"
	
	STRINGS.UI.ARCTIC_FOOL_FISH_BUTTON = "\"Uderz mnie!\""
