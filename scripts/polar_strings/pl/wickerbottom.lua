...
DESCRIBE.MOOSE_SPECTER = "Ten okaz wartoby było zbadać!"
...
DESCRIBE.BLUEGEM_SHARDS =
"Materia nie może powstać z niczego, ani zostać zredukowana do niczego, może byc tylko rozproszona."
...
--	Others
DESCRIBE.ARCTIC_FOOL_FISH =
"Symbol towarzyskiego obyczaju, ceniony zarówno przez niedźwiedziowate jak i przez Francuzów."
DESCRIBE.POLARGLOBE = {
