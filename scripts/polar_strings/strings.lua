...
--	Worldgen
	...
	NAMES.POLARBEAR_MATERIAL = "Bring Polar Bears"
...
--	Buildings
	...
	NAMES.POLARHEADSTICK_NAME = "Some Sticks So Far"
...
--	Items
	...
	NAMES.HERMITCRABTEA_PETALS_POLAR = "Crocus Petal Tea"
	...
	NAMES.POLARFLEAEGGSACK = "Snowflea Egg Sacs"
	...
	NAMES.PETALS_POLAR = "Crocus Petals"
	NAMES.PETALS_POLAR_DRIED = "Dried Crocus Petals"
	...
	NAMES.FLOWER_POLARHAT = "Vernal Chaplet"
	...
	NAMES.TURF_POLAR_GRASS = "Tundra Turf"
...
--	Speech, etc
	...
	STRINGS.POLARBEAR_LOOKATWILSON_HOT = {"CAN'T PLAY IN SNOW", "GUESS NO PLOWING TODAY", "I MISS THE SNOW", "IS GETTING WARM HERE...", "IS HOT OUTSIDE", "IS HOT INSIDE TOO", "OH HO HO HOT!", "PFEW... SO HOT", "WHAT HAPPENED TO SNOW?", "WHERE'S THE SNOW AT?"}
	...
	STRINGS.POLARBEAR_HELP_CHOP_WOOD = {"GOODBYE TREE", "CHOP CHOP!", "HUFF", "HO HO! SO EASY", "ALWAYS MORE WOOD...", "PUNCH LIKE AN AXE!"}
	...
	STRINGS.POLARBEARKING_TRIAL_LOW_HEALTH = {"HEAL UP, THEN WE'LL TALK", "YOU CAN HARDLY STAND ON YOUR LEGS, SON"}
...
--	UI
	...
	STRINGS.SCRAPBOOK.SPECIALINFO.FLOWER_POLARHAT = "Reverses harmful effects from ingested food in proportion to the chaplet freshness."
	...
	STRINGS.SCRAPBOOK.SPECIALINFO.HERMITCRABTEA_PETALS_EVIL = "A brewed concoction from Pearl... it's perhaps best if YOU don't drink it."
	...
	RECIPE_DESC.FLOWER_POLARHAT = "Makes your guts feel over your head."
	RECIPE_DESC.FROSTWALKERAMULET = "Never was water this cool before!"
	RECIPE_DESC.HERMITCRABTEA_PETALS_POLAR = "Looks good? That's because it is(n't)."
	RECIPE_DESC.ICICLESTAFF = "Summon the very things you swore to destroy."
	RECIPE_DESC.POCKETWATCH_POLAR = "Stats paused!\nSeriously. They are!"
	...
	RECIPE_DESC.TURF_POLAR_GRASS = "A patch of an emergent flower field."
	...
	STRINGS.UI.CUSTOMIZATIONSCREEN.FLOWERS_POLAR = "Crocus Bloom"
	...
	STRINGS.UI.CUSTOMIZATIONSCREEN.POLARFLEA_MOTHER = "Motherflea"
	STRINGS.UI.CUSTOMIZATIONSCREEN.POLARFLEA_MOTHERS = "Motherfleas"
	STRINGS.UI.CUSTOMIZATIONSCREEN.POLARFOXES = "Frost Tails"
	STRINGS.UI.CUSTOMIZATIONSCREEN.POLARICE = "Freezing Shoreline Size"
	STRINGS.UI.CUSTOMIZATIONSCREEN.POLARSNOW = "High Snow"
	STRINGS.UI.CUSTOMIZATIONSCREEN.POLARSNOW_MELT = "Snow Melting Range"
	STRINGS.UI.CUSTOMIZATIONSCREEN.POLARSTORMS = "Blizzard Episodes"
