...
--	Speech, etc
	STRINGS.POLARCOLD_SNUFFING = {"(SNORT)", "(SNIFF)", "(SNURF)", "(HUFF)", "(SNUFFLE)"}
	...
	STRINGS.POLARBEAR_GOHOME = {"{snuff}YAAAWN!", "GETTING EEPY...", "CAN'T BEAR{snuff}THE DARK!"}
	STRINGS.POLARBEAR_PANICHAUNT = {"{snuff}ACK!", "EEP{snuff}!", "POSSESSED SNOW!"}
	STRINGS.POLARBEAR_PANICFIRE = {"EEP!", "NOT COOL! NOT COOL!", "I MELT!"}
	STRINGS.POLARBEAR_PANICHOUSEFIRE = {"OH NO{snuff}NO NO!", "ANYBODY COOKING FISH?", "MY HOME MELTING!"}
