...
--	Speech, etc
	...
	STRINGS.POLARBEAR_FOLLOWWILSON = {"LET'S GO FISHING", "WHERE WE GOING?", "SNIFF SNIFFFF", "YOU'RE SMALL, BUT GOOD", "OH OH OH!", "I AM RIGHT BEHIND YOU", "ARE YOU NOT COLD?", "EH? COMING!"}
	...
	STRINGS.POLARBEAR_FIND_FOOD = {"MMM... FOOD", "OH OH!", "WHAT NICE SMELL!", "THIS LOOK'S GOOD", "SLURP... FOOD", "OH OH OH YES!"}
	...
	STRINGS.POLARBEAR_PANICHAUNT = {"ACK!", "EEP!", "POSSESSED SNOW!", "OH OH OOOOO"}
	STRINGS.POLARBEAR_PANICFIRE = {"FIIIREEE!", "NOT COOL! NOT COOL!", "I MELT!", "AAAAAA", "OH OH OH NOOO"}
