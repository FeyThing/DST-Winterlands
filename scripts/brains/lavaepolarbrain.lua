...
local function GetOwner(inst)
	...
	local owner = leader ~= nil and leader.components.inventoryitem and leader.components.inventoryitem:GetGrandOwner() or nil
...
local function LoveOwner(inst)
	...
	return owner ~= nil
		...
		and inst.components.hunger:GetPercent() > 0.15
		and math.random() < 0.5
		and BufferedAction(inst, owner, ACTIONS.NUZZLE)
		or nil
end

local LavaePolarBrain = Class(Brain, function(self, inst)
