local POLAR_SCRAPBOOK = {
	...
	polaramulet = {type = "item", subcat = "clothing", build = "torso_polar_amulet", bank = "torso_polar_amulet", anim = "idle", deps = {"houndstooth", "gnarwail_horn", "polarwargstooth", "rope", "walrus_tusk"}, specialinfo = "POLARAMULET"},
