...
description = info_version..[[ Sunny Side Up-date
...
local descs = {
	...
	menumelt = "Turn on the heater to remove the frosty jumpscare when enabling Winterlands on your server. Brr!",
	music = "Enable or disable the mod's soundtrack.",
	shader = "It's always winter in here, literally and visually speaking.",
}
...
local options = {
	...
	language = {{description = "English", data = false}, {description = "简体中文", data = "zhs", hover = "By heavenmoon0107"}, {description = "繁體中文", data = "zht", hover = "By heavenmoon0107"}, {description = "Español", hover = "By AlastorYT", data = "es"}, {description = "Français", hover = "By ADM & Steamerclaw", data = "fr"}, {description = "한국인", hover = "By taeseong1120", data = "kr"}, {description = "Polski", hover = "By LukaS", data = "pl"}},
